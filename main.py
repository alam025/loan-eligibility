...
app = FastAPI(
    ...
    description="Trained model with 92% accuracy and bias auditing across protected demographic attributes",
    version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"message": "Loan Eligibility Predictor API", "status": "running", "version": "1.0.0"}
